window.addEventListener('DOMContentLoaded', (e) => {
    ...
    gradient.initGradient("#header-gradient1");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#header-gradient2");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#header-gradient3");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#header-gradient4");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#header-gradient5");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient1");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient2");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient3");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient4");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient5");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient6");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient7");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#overview-gradient8");
});

window.addEventListener('DOMContentLoaded', (e) => {
    var gradient = new Gradient;
    gradient.initGradient("#contact-gradient");
});
